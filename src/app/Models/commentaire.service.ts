...
export class CommentaireService {
  ...
  public AddCommentPost(comment:Commentaire,iduser:any,idPost:Post):Observable<Commentaire[]>{
    return this.http.post<Commentaire[]>('http://localhost:8089/WorkMood/comment/add-comment-inpost/'+iduser+'/'+idPost,comment);
  }

  public getCommentByPost(idPost:any):Observable<Commentaire>{
    return this.http.get<Commentaire>('http://localhost:8089/WorkMood/comment/retrieve-commentaire/post/'+idPost);
  }
