...
export class PostService {
  ...
  public listPostes():Observable<Post[]>{
    return this.http.get<Post[]>('http://localhost:8089/work-mood/post/retrieve-all-posts');
  }

  public AddPost(post:Post,id:any):Observable<Post[]>{
    return this.http.post<Post[]>('http://localhost:8089/work-mood/post/add-post/'+id,post);
  }

  public getPostById(id:any):Observable<Post>{
    return this.http.get<Post>('http://localhost:8089/work-mood/post/retrieve-post/'+id);
  }
  ...
  public deletepostes(idPost:any){
    return this.http.delete<Post[]>('http://localhost:8089/work-mood/post/remove-post/'+idPost);
  }
